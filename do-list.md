...
> 23.03.15
  - 바코드 출력물(barcode page)출력물 확인
  - 페이지 정리
  - 요율관리, Stuffing
  - 기념일 메일관련 물어보기
  - 반입신고 출력물에 필드값이 하나 없음
  - 해당되는 테이블에 링크 걸기(현재 입고관리 입고리스트까지 확인중)
  - DB예시필드 필요하면 변경
  - 입고관리 입고검수관리 출력물 2개
...
> 23.03.16
  - 바코드 출력물(barcode page)출력물 확인
  - 페이지 정리
  - 요율관리, stuffing(일정보고 이번주, 다음주판단)
  - 기념일 메일관련 물어보기
  - 반입신고 출력물에 필드값이 하나 없음
  - 해당되는 테이블에 링크 걸기(현재 입고관리 입고관리페이지까지 확인중)
  - DB예시필드 필요하면 변경

> 23.03.17
  - 바코드 출력물(barcode page)확인
  - 페이지 정리
  - stuffing, 요율관리(오늘 db링크및 필드 예시값 점검)
  - 기념일 관련 메일 물어보기
  - 반입신고 출력물에 필드값이 하나 없음
  - 해당되는 테이블에 링크 걸기
  - db 예시필드 필요하면 변경
  - 일일반입보고서 출력물 다시한번 검토(출력하는 양이 많아서 검토해야됨)

> 23.03.20
  - 바코드 출력물(barcode page)확인
  - 페이지 정리
  - stuffing, 요율관리(stuffing 1개완료, 나머지 1개 진행중)
  - 기념일 관련 메일 수정
  - 반입신고 출력물에 필드값이 하나 없음
  - 해당되는 테이블에 링크 걸기
  - db 예시필드 필요하면 변경
  - 일일반입보고서 출력물 다시한번 검토(출력양 많아 검토)

> 23.03.21
  - 바코드 페이지(barcode page)출력물 확인
  - 페이지 정리
  - stuffing(완료), 요율관리(진행)
  - 기념일 메일 수정하기
  - 반입신고 출력물에 필드값이 하나 없음
...
> 23.03.22
  ...
  - 해당되는 테이블에 링크 걸기
  - DB 예시 필드 필요하면 변경
  - 분실신고서, 폐기신고및 완료보고 출력물 
  - jasper db 연동파일(java파일)
...
> 23.03.23
  ...
  - 해당 되는 테이블에 링크 걸기
  - DB 예시 필드 필요하면 변경
  - 재고인수증 출력물 1:1로 나오게 수정(페이지 넘버링까지 지정)
...
> 23.03.24
  ...
  - 기념일 메일 수정하기
  - 반입신고 출력물에 필드값이 하나 없음
  - 해당되는 테이블에 링크 걸기(현재 요율관리 진행된 것까지 진행중)
  - DB 예시 필드 필요하면 변경
  - 재고인수증 출력물 1:1로 나오게 수정완료
  - 창고료 매출 정산관리 출력물 임시 완료(나중에 한번더 확인)
...
> 23.03.29
  ...
  - 기념일 메일 수정하기
  - 반입신고 출력물에 필드값이 하나 없음
  - 해당되는 테이블에 링크걸기(현재 정산관리 진행중인 것까지 진행중)
  - DB 예시 필드 필요하면 변경
  - 본사/지사간 내부거래 내역조회 출력물 진행
...
> 23.03.30
  ...
  - 기념일 메일 수정하기
  - 반입신고 출력물에 필드값이 하나 없음
  - 해당되는 테이블에 링크 걸기(현재 정산관리 진행된 것까지 진행중)
  - DB 예시 필드 필요하면 변경
  - 본사/지사간 내부거래 내역 조회 출력물 진행
...
> 23.04.06
  ...
  - 기념일 메일 수정하기
  - 반입신고 출력물에 필드값이 하나 없음
  - 해당되는 테이블에 링크걸기(현재 정산관리 진행된 것까지 진행중)
  - DB 예시 필드 필요하면 변경
  - 본사/지사간 내부거래 내역 조회 출력물 진행
